...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(145deg,#FFF8EF 0%,#FFF0DC 60%,#F5E8D6 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
      <div style={{ position: 'absolute', top: 22, left: 56 }}>
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: '13.5px', fontWeight: 500, color: 'var(--text-mid)', textDecoration: 'none' }}>
